...
//     setUploading(true);
//     try {
//       // Use your custom imageUpload function
...
//         `${import.meta.env.VITE_API_URL}/meals`, // your backend endpoint
//         mealData
//       );
...
//   return (
//     <div className="max-w-lg mx-auto p-6 bg-base-200 rounded shadow mt-10">
...
const AddMeal = () => {
  ...
  return (
    <div className="  max-w-lvh w-full  mt-10 bg-base-200 p-4 rounded-lg shadow-md overflow-y-auto max-h-[90vh]">
      <h2 className="text-2xl font-bold mb-6 text-center">Add Meal</h2>
