...
const TreeShirt = () => {
  ...
  return (
    <div className="px-4 py-8 max-w-7xl mx-auto">
      <h2 className="text-3xl font-bold mb-8 text-center text-gray-800">Shirt Collection</h2>
      ...
      <InfiniteScroll
        ...
        endMessage={<p className="text-center mt-4 text-gray-500">No more shirts to display</p>}
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {shirts.map((shirt) => (
            ...
            >
              <div className="relative w-9/12 mx-auto lg:w-full h-full lg:h-64">
                <img
                  src={shirt.image}
                  alt={shirt.title}
